...
<nav className="navbar bg-dark border-bottom border-body" data-bs-theme="dark">
			...
			<ul class="nav nav-pills nav-pills nav-pills-container" id="pills-tab" role="tablist">
				<Link to="/">
					...
					<li class="nav-item search-box" role="search">
						<input class="form-control me-2 search-button-white" type="search" placeholder="Search" aria-label="Search"/>
					</li>
					<li class="nav-item sign-in-button" role="search">
					<button class="btn btn-light search-button-white" type="submit">Search</button>
					</li>
					<li class="nav-item" role="presentation">
